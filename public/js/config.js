...
const ETYPES=[
  ...
  {name:'Swamp Snail',     r:14,hp:240,spd:22,dmg:16,xpV:3,xpC:4,col:'#6a9a3a',wave:2,cls:'A'},
  {name:'Ram Rusher',      r:14,hp:90, spd:24,dmg:20,xpV:3,xpC:1,col:'#8b7744',wave:3,cls:'C'},
  {name:'Funky Fox',       r:11,hp:85, spd:72,dmg:18,xpV:3,xpC:1,col:'#c85a1a',wave:3,cls:'C'},
