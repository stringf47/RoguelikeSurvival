...
/* ── ENEMY TYPES ── */
const ETYPES=[
  {name:'Corrupt Pig',     r:13,hp:35, spd:36,dmg:12,xpV:2,xpC:2,col:'#cc6688',wave:0},
  ...
  {name:'Shambling Sheep', r:15,hp:220,spd:22,dmg:18,xpV:3,xpC:4,col:'#c8d4cc',wave:2,cls:'A'},
  {name:'Swamp Snail',     r:14,hp:240,spd:34,dmg:16,xpV:3,xpC:4,col:'#6a9a3a',wave:2,cls:'A'},
  {name:'Ram Rusher',      r:14,hp:90, spd:24,dmg:20,xpV:3,xpC:1,col:'#8b7744',wave:3,cls:'C'},
  {name:'Funky Fox',       r:11,hp:140,spd:80,dmg:18,xpV:3,xpC:1,col:'#c85a1a',wave:3,cls:'C'},
