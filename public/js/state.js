...
let ccSpawnIdx=0,crimsonCrossBuffActive=false,crimsonCrossBuffT=0,crimsonCrossDebuff='';
let corruptedZones=[];
let bgWave=0;
let runPool=[];
let enemyDmgMult=1;
let sealSpottedT=0,ccSpottedT=0;
let sealBuffT=0;
let sealVignette=0,crimsonVignette=0;
